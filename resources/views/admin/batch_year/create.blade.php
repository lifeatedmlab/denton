    ...
    <div class="col-lg-6 col-7">
        ...
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ route('batch_year.index') }}">Batch Year</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add Batch Year</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Add Batch Year</h3>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('batch_year.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
