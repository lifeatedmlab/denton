...
<div class="row align-items-center py-4">
    ...
    <div class="col-lg-6 col-5 text-right">
        <a href="{{ route('position.index') }}" class="btn btn-md btn-neutral">
            << Position List</a>
    </div>
</div>
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ old('position', $position->position) }}" name="position" placeholder="ex: Lead of Project" />
