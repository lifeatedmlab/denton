                ...
                <form action="{{ route('member.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control text-dark" id="name" name="name" placeholder="The new member full name" required>
                        </div>
                        <div class="col mb-3">
                            <label class="form-control-label" for="code">Member Code</label>
                            <input type="text" class="form-control text-dark" id="code" name="code" placeholder="The new member code" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col mb-3">
                            <label class="form-control-label" for="position">Position</label>
                            <input type="text" class="form-control text-dark" id="position" name="position"  placeholder="The new member position" required>
                        </div>
                        <div class="col mb-3">
